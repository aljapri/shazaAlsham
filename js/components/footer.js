let footerContent = `         <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <h1 class="fw-bold text-primary mb-4">Shaza<span class="text-secondary">Alsham</span></h1>
...
let footer_section = document.getElementsByClassName("footer__section");


for(let i = 0;i < footerContent.length;i++){
    footer_section[i].innerHTML +=footerContent
}
